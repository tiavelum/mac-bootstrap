...
password once (and keeps it fresh for the rest of the run), installs
Homebrew and `gh`, then stops: `Not authenticated with GitHub`. In the
**same** Terminal window, type:
